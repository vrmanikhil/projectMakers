    ...
    <div class="container">
      ...
      <?php }?>
        ...
        <div class="row page-header">
            <?php echo $navigation; ?>
            <div class="col-md-9">
                <a href="<?php echo base_url('/backoffice/menuCategories'); ?>">Go Back</a>
                <h3>Edit Menu Category</h3>
                <div class="col-sm-12">
                  <form action="<?php echo base_url('backofficeFunctions/updateMenuCategory'); ?>" method="post">
                      <div class="control-group form-group">
                          <div class="controls">
                              <label>Name:</label>
                              <input type="text" class="form-control" name="name" value="<?php echo $categoryData['name']; ?>" required>
                      ...
                      <div class="control-group form-group">
                          <div class="controls">
                              ...
                              <textarea class="form-control" id="description" rows="10" name="description" required><?php echo $categoryData['description']; ?></textarea>
                              <p class="help-block"></p>
                          </div>
                      </div>
