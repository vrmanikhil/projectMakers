<section class="banner flex flex-col" style="background-image: url('<?php echo base_url().$images[0]['imageURL']; ?>')">
	<div class="container-fluid fixed-width-container">
		...
		<p class="banner__description"><?php echo $home['content1']; ?></p>
	</div>
</section>
<section class="featured-links">
	<div class="container-fluid fixed-width-container flex">
		<a href="javascript:" class="featured-link__box flex" style="background-image: url('<?php echo base_url().$images[2]['imageURL']; ?>')">Who we are</a>
		<a href="javascript:" class="featured-link__box flex" style="background-image: url('<?php echo base_url().$images[3]['imageURL']; ?>')">Our Menu</a>
...
<section class="banner flex flex-col" style="background-image: url('<?php echo base_url().$images[1]['imageURL']; ?>">
	<div class="container-fluid fixed-width-container">
		...
		<p class="banner__description"><?php echo $home['content2']; ?></p>
	</div>
</section>
